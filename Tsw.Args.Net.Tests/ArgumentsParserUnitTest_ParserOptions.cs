...
{
    public class ArgumentsParserUnitTest_ParserOptions
    {
        [Fact]
        ...
        [Fact]
        public void TestOptionsOnlyUsingShortcuts()
        {
            var options = new ParserOptions
            {
                OptionPrefix = "//",
        ...
        [Fact]
        public void TestArgumentsBeforeOptionsUsingShortcuts()
        {
            var options = new ParserOptions
            {
                OptionPrefix = "//",
        ...
        [Fact]
        public void TestArgumentsAfterOptionsUsingShortcuts()
        {
            var options = new ParserOptions
            {
                OptionPrefix = "//",
        ...
        [Fact]
        public void TestArgumentsBetweenOptionsUsingShortcuts()
        {
            var options = new ParserOptions
            {
                OptionPrefix = "//",
        ...
        [Fact]
        public void TestOptionsBetweenArgumentsUsingShortcuts()
        {
            var options = new ParserOptions
            {
                OptionPrefix = "//",
